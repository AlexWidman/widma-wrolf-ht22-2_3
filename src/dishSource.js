...
function treatHTTPResponseACB(response){ 
 ...
 function getDishDetails(id){
    return fetch(BASE_URL+'https://spoonacular-recipe-food-nutrition-v1.p.rapidapi.com/recipes/'+id+'/information', {  // object literal
